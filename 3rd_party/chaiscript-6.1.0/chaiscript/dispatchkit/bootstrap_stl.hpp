    ...
    namespace bootstrap {
      ...
      ///       the user_typetraits of the iterator passed in
            ...
            void input_range_type(const std::string &type, Module &m) {
                ...
                detail::input_range_type_impl<Bidir_Range<const ContainerType, typename
                    ContainerType::const_iterator> >("Const_" + type, m);
            }
      ...
      /// http://www.cplusplus.com/reference/stl/
            ...
            void reservable_type(const std::string &/*type*/, Module &m) {
                m.add(fun([](ContainerType *a, typename ContainerType::size_type n) { return a->reserve(n); }),
                      "reserve");
      ...
      /// http://www.sgi.com/tech/stl/pair.html
            ...
            void pair_type(const std::string &type, Module &m) {
                ...
                m.add(constructor<PairType (const typename PairType::first_type &,
                                            const typename PairType::second_type &)>(), type);
            }
      ...
      /// http://www.sgi.com/tech/stl/Map.html
            ...
            void map_type(const std::string &type, Module &m) {
                ...
                typedef const typename MapType::mapped_type &(MapType::*const_elem_access)(
                    const typename MapType::key_type &) const;
      ...
      /// http://www.sgi.com/tech/stl/basic_string.html
            ...
            void string_type(const std::string &type, Module &m) {
                ...
                m.add(fun([](const String *s, const String &f, size_t pos) { return s->find_first_of(f, pos); }),
                      "find_first_of");
                m.add(fun([](const String *s, const String &f, size_t pos) { return s->find_last_of(f, pos); }),
                      "find_last_of");
