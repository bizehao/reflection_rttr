        ...
        namespace detail {
            ...
            struct Handle_Return<const std::function<Ret> &> {
                static Boxed_Value handle(const std::function<Ret> &f) {
                    return Boxed_Value(
                        chaiscript::make_shared<Proxy_Function_Base,
                            Proxy_Function_Callable_Impl<Ret, std::function<Ret> > >(f));
                }
            };
            ...
            struct Handle_Return<const std::shared_ptr<std::function<Ret> >> {
                static Boxed_Value handle(const std::shared_ptr<std::function<Ret> > &f) {
                    return Boxed_Value(
                        chaiscript::make_shared<Proxy_Function_Base, Assignable_Proxy_Function_Impl<Ret> >(
                            std::ref(*f),
                            f));
                }
            };
