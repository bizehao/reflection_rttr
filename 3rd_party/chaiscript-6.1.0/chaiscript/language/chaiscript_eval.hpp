...
namespace chaiscript {
    ...
    namespace eval {
        ...
        namespace detail {
            ...
            static Boxed_Value eval_function(chaiscript::detail::Dispatch_Engine &t_ss, const AST_Node_Impl<T> &t_node,
                                             ...
                                             const std::vector<Boxed_Value> &t_vals,
 ...
 const chaiscript::detail::Dispatch_State & t_ss)> t_func) : AST_Node_Impl<T>(t_original_node->text,
                                                                              AST_Node_Type::Compiled,
                                                                              t_original_node->location,
                                                                              std::move(t_children)),
            ...
            std::function<Boxed_Value(const std::vector<AST_Node_Impl_Ptr<T> > &,
 const chaiscript::detail::Dispatch_State & t_ss)> m_func;
        ...
        struct Fold_Right_Binary_Operator_AST_Node : AST_Node_Impl<T> {
            Fold_Right_Binary_Operator_AST_Node(const std::string &t_oper, Parse_Location t_loc,
                                                ...
                                                Boxed_Value t_rhs) : AST_Node_Impl<T>(t_oper, AST_Node_Type::Binary,
                                                                         std::move(t_loc), std::move(t_children)),
        ...
        protected:
            Boxed_Value do_oper(const chaiscript::detail::Dispatch_State &t_ss,
                ...
                try {
                    ...
                    throw exception::eval_error("Can not find appropriate '" + t_oper_string + "' operator.",
        ...
        struct Binary_Operator_AST_Node : AST_Node_Impl<T> {
            Binary_Operator_AST_Node(const std::string &t_oper, Parse_Location t_loc,
                                     std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                    t_oper, AST_Node_Type::Binary, std::move(t_loc), std::move(t_children)),
                m_oper(Operators::to_operator(t_oper)) {
            }
        ...
        protected:
            Boxed_Value do_oper(const chaiscript::detail::Dispatch_State &t_ss,
                                Operators::Opers t_oper, const std::string &t_oper_string, const Boxed_Value &t_lhs,
                                const Boxed_Value &t_rhs) const {
                try {
                    if (t_oper != Operators::Opers::invalid && t_lhs.get_type_info().is_arithmetic() && t_rhs.
        ...
        struct Id_AST_Node final : AST_Node_Impl<T> {
            Id_AST_Node(const std::string &t_ast_node_text, Parse_Location t_loc) : AST_Node_Impl<T>(
                t_ast_node_text, AST_Node_Type::Id, std::move(t_loc)) {
            }
        ...
        struct Fun_Call_AST_Node : AST_Node_Impl<T> {
            Fun_Call_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Fun_Call, std::move(t_loc), std::move(t_children)) {
            ...
            Boxed_Value do_eval_internal(const chaiscript::detail::Dispatch_State &t_ss) const {
                ...
                try {
                    ...
                    throw exception::eval_error(
                        std::string(e.what()) + " with function '" + this->children[0]->text + "'", e.parameters,
                    ...
                    try {
                        ...
                        throw exception::eval_error("Error calling function '" + this->children[0]->text + "'", params,
                                                    {f}, false, *t_ss);
                    }
                    catch (const exception::bad_boxed_cast &) {
                        throw exception::eval_error(
                            "'" + this->children[0]->pretty_print() + "' does not evaluate to a function.");
                    }
                }
                catch (const exception::arity_error &e) {
                    throw exception::eval_error(
                        std::string(e.what()) + " with function '" + this->children[0]->text + "'");
                }
        ...
        struct Unused_Return_Fun_Call_AST_Node final : Fun_Call_AST_Node<T> {
            Unused_Return_Fun_Call_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : Fun_Call_AST_Node<T>(
                std::move(t_ast_node_text), std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Arg_AST_Node final : AST_Node_Impl<T> {
            Arg_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                         std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Arg_List, std::move(t_loc), std::move(t_children)) {
            }
        };

        template<typename T>
        struct Arg_List_AST_Node final : AST_Node_Impl<T> {
            Arg_List_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Arg_List, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Equation_AST_Node final : AST_Node_Impl<T> {
            Equation_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                                                                                   std::move(t_ast_node_text),
                                                                                   AST_Node_Type::Equation,
                                                                                   std::move(t_loc),
                                                                                   std::move(t_children)),
                                                                               m_oper(
                                                                                   Operators::to_operator(this->text)) {
        ...
        struct Global_Decl_AST_Node final : AST_Node_Impl<T> {
            Global_Decl_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                 std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Global_Decl, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Var_Decl_AST_Node final : AST_Node_Impl<T> {
            Var_Decl_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Var_Decl, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Assign_Decl_AST_Node final : AST_Node_Impl<T> {
            Assign_Decl_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                 std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Assign_Decl, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Array_Call_AST_Node final : AST_Node_Impl<T> {
            Array_Call_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Array_Call, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Dot_Access_AST_Node final : AST_Node_Impl<T> {
            Dot_Access_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                    std::move(t_ast_node_text), AST_Node_Type::Dot_Access, std::move(t_loc), std::move(t_children)),
                m_fun_name(
                    ((this->children[1]->identifier == AST_Node_Type::Fun_Call) || (
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State &t_ss) const override {
                ...
                try {
                    ...
                    if (e.functions.empty()) {
                        ...
                        throw exception::eval_error(std::string(e.what()) + " for function '" + m_fun_name + "'",
                                                    e.parameters, e.functions, true, *t_ss);
                    }
                }
                catch (detail::Return_Value &rv) {
                ...
                if (this->children[1]->identifier == AST_Node_Type::Array_Call) {
                    try {
                        retval = t_ss->call_function("[]", m_array_loc,
                                                     {retval, this->children[1]->children[1]->eval(t_ss)},
                                                     t_ss.conversions());
                    }
                    catch (const exception::dispatch_error &e) {
        ...
        struct Lambda_AST_Node final : AST_Node_Impl<T> {
            Lambda_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(t_ast_node_text,
                                                                                 ...
                                                                                 std::vector<AST_Node_Impl_Ptr<T> >(
                                                                                     std::make_move_iterator(
                                                                                         t_children.begin()),
                                                                                     std::make_move_iterator(
                                                                                         std::prev(t_children.end())))
                                                                             ),
                                                                             m_param_names(
                                                                                 Arg_List_AST_Node<T>::get_arg_names(
                                                                                     *this->children[1])),
                                                                             m_this_capture(
                                                                                 has_this_capture(
                                                                                     this->children[0]->children)),
                                                                             m_lambda_node(
                                                                                 std::move(t_children.back())) {
            }
                ...
                const auto captures = [&]()-> std::map<std::string, Boxed_Value> {
                    ...
                    for (const auto &capture: this->children[0]->children) {
                        named_captures.insert(
                            std::make_pair(capture->children[0]->text, capture->children[0]->eval(t_ss)));
                    }
        ...
        struct Scopeless_Block_AST_Node final : AST_Node_Impl<T> {
            Scopeless_Block_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                     std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Scopeless_Block, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Block_AST_Node final : AST_Node_Impl<T> {
            Block_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                           std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Block, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Def_AST_Node final : AST_Node_Impl<T> {
            ...
            Def_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                         std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(std::move(t_ast_node_text),
                                                                              AST_Node_Type::Def, std::move(t_loc),
                                                                              std::vector<AST_Node_Impl_Ptr<T> >(
                                                                                  std::make_move_iterator(
                                                                                      t_children.begin()),
                                                                                  std::make_move_iterator(
                                                                                      std::prev(t_children.end(),
                                                                                          has_guard(t_children, 1)
                                                                                              ? 2
                                                                                              : 1)))
                                                                          ),
                                                                          ...
                                                                          // on each operation.
                                                                          m_body_node(
                                                                              get_body_node(std::move(t_children))),
                                                                          m_guard_node(
                                                                              get_guard_node(
                                                                                  std::move(t_children),
                                                                                  t_children.size() - this->children.
                                                                                  size() == 2)) {
            }

            static std::shared_ptr<AST_Node_Impl<T> > get_guard_node(std::vector<AST_Node_Impl_Ptr<T> > &&vec,
                                                                     bool has_guard) {
                if (has_guard) {
            ...
            static bool has_guard(const std::vector<AST_Node_Impl_Ptr<T> > &t_children, const std::size_t offset) {
                if ((t_children.size() > 2 + offset) && (
                        t_children[1 + offset]->identifier == AST_Node_Type::Arg_List)) {
        ...
        struct While_AST_Node final : AST_Node_Impl<T> {
            While_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                           std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::While, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Class_AST_Node final : AST_Node_Impl<T> {
            Class_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                           std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Class, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct If_AST_Node final : AST_Node_Impl<T> {
            If_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                        std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::If, std::move(t_loc), std::move(t_children)) {
        ...
        struct Ranged_For_AST_Node final : AST_Node_Impl<T> {
            Ranged_For_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Ranged_For, std::move(t_loc), std::move(t_children)) {
                assert(this->children.size() == 3);
            }
        ...
        struct For_AST_Node final : AST_Node_Impl<T> {
            For_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                         std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::For, std::move(t_loc), std::move(t_children)) {
        ...
        struct Switch_AST_Node final : AST_Node_Impl<T> {
            Switch_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Switch, std::move(t_loc), std::move(t_children)) {
            }
                ...
                while (!breaking && (currentCase < this->children.size())) {
                    try {
                        if (this->children[currentCase]->identifier == AST_Node_Type::Case) {
                            ...
                            try {
                                if (hasMatched || boxed_cast<bool>(t_ss->call_function(
                                        "==", m_loc,
                                        {match_value, this->children[currentCase]->children[0]->eval(t_ss)},
                                        t_ss.conversions()))) {
        ...
        struct Case_AST_Node final : AST_Node_Impl<T> {
            Case_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                          std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Case, std::move(t_loc), std::move(t_children)) {
        ...
        struct Default_AST_Node final : AST_Node_Impl<T> {
            Default_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                             std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Default, std::move(t_loc), std::move(t_children)) {
        ...
        struct Inline_Array_AST_Node final : AST_Node_Impl<T> {
            Inline_Array_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                  std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Inline_Array, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Inline_Map_AST_Node final : AST_Node_Impl<T> {
            Inline_Map_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Inline_Map, std::move(t_loc), std::move(t_children)) {
            }
                    ...
                    for (const auto &child: this->children[0]->children) {
                        retval.insert(std::make_pair(t_ss->boxed_cast<std::string>(child->children[0]->eval(t_ss)),
                                                     detail::clone_if_necessary(
                                                         child->children[1]->eval(t_ss), m_loc, t_ss)));
                    }
        ...
        struct Return_AST_Node final : AST_Node_Impl<T> {
            Return_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Return, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct File_AST_Node final : AST_Node_Impl<T> {
            File_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                          std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::File, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Reference_AST_Node final : AST_Node_Impl<T> {
            Reference_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                               std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Reference, std::move(t_loc), std::move(t_children)) {
                assert(this->children.size() == 1);
            }
        ...
        struct Prefix_AST_Node final : AST_Node_Impl<T> {
            Prefix_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                                                                                 std::move(t_ast_node_text),
                                                                                 AST_Node_Type::Prefix,
                                                                                 std::move(t_loc),
                                                                                 std::move(t_children)),
                                                                             m_oper(Operators::to_operator(
                                                                                 this->text, true)) {
            }
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State &t_ss) const override {
                ...
                try {
                    ...
                    if (m_oper != Operators::Opers::invalid && m_oper != Operators::Opers::bitwise_and && bv.
                        get_type_info().is_arithmetic()) {
                    ...
                    throw exception::eval_error("Error with prefix operator evaluation: '" + this->text + "'",
                                                e.parameters, e.functions, false, *t_ss);
                }
            }
        ...
        struct Break_AST_Node final : AST_Node_Impl<T> {
            Break_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                           std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Break, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Continue_AST_Node final : AST_Node_Impl<T> {
            Continue_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Continue, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Map_Pair_AST_Node final : AST_Node_Impl<T> {
            Map_Pair_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                              std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Map_Pair, std::move(t_loc), std::move(t_children)) {
            }
        };
        ...
        struct Value_Range_AST_Node final : AST_Node_Impl<T> {
            Value_Range_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                 std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Value_Range, std::move(t_loc), std::move(t_children)) {
            }
        };
        ...
        struct Inline_Range_AST_Node final : AST_Node_Impl<T> {
            Inline_Range_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                  std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Inline_Range, std::move(t_loc), std::move(t_children)) {
            }
            ...
            Boxed_Value eval_internal(const chaiscript::detail::Dispatch_State &t_ss) const override {
                try {
                    ...
                    throw exception::eval_error("Unable to generate range vector, while calling 'generate_range'",
                                                e.parameters, e.functions, false, *t_ss);
                }
            }
        ...
        struct Try_AST_Node final : AST_Node_Impl<T> {
            Try_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                         std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Try, std::move(t_loc), std::move(t_children)) {
            }

            Boxed_Value handle_exception(const chaiscript::detail::Dispatch_State &t_ss,
                                         const Boxed_Value &t_except) const {
                Boxed_Value retval;
        ...
        struct Catch_AST_Node final : AST_Node_Impl<T> {
            Catch_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                           std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Catch, std::move(t_loc), std::move(t_children)) {
            }
        };

        template<typename T>
        struct Finally_AST_Node final : AST_Node_Impl<T> {
            Finally_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                             std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Finally, std::move(t_loc), std::move(t_children)) {
            }
        };
        ...
        struct Method_AST_Node final : AST_Node_Impl<T> {
            ...
            Method_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                            std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                                                                                 std::move(t_ast_node_text),
                                                                                 ...
                                                                                 std::vector<AST_Node_Impl_Ptr<T> >(
                                                                                     ...
                                                                                     std::make_move_iterator(
                                                                                         std::prev(t_children.end(),
                                                                                             Def_AST_Node<T>::has_guard(
                                                                                                 t_children, 1)
                                                                                                 ? 2
                                                                                                 : 1)))
                                                                             ),
                                                                             m_body_node(
                                                                                 Def_AST_Node<T>::get_body_node(
                                                                                     std::move(t_children))),
                                                                             m_guard_node(
                                                                                 Def_AST_Node<T>::get_guard_node(
                                                                                     std::move(t_children),
                                                                                     t_children.size() - this->children.
                                                                                     size() == 2)) {
            }
                    ...
                    if (function_name == class_name) {
                        ...
                        t_ss->add(
                            std::make_shared<dispatch::detail::Dynamic_Object_Constructor>(class_name,
                                dispatch::make_dynamic_proxy_function(
                                    [engine, t_param_names, node = m_body_node](
                                const std::vector<Boxed_Value> &t_params) {
                                        return chaiscript::eval::detail::eval_function(
                                            engine, *node, t_param_names, t_params);
                                    },
        ...
        struct Attr_Decl_AST_Node final : AST_Node_Impl<T> {
            Attr_Decl_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                               std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Attr_Decl, std::move(t_loc), std::move(t_children)) {
            }
        ...
        struct Logical_And_AST_Node final : AST_Node_Impl<T> {
            Logical_And_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                 std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Logical_And, std::move(t_loc), std::move(t_children)) {
                assert(this->children.size() == 2);
            }
        ...
        struct Logical_Or_AST_Node final : AST_Node_Impl<T> {
            Logical_Or_AST_Node(std::string t_ast_node_text, Parse_Location t_loc,
                                std::vector<AST_Node_Impl_Ptr<T> > t_children) : AST_Node_Impl<T>(
                std::move(t_ast_node_text), AST_Node_Type::Logical_Or, std::move(t_loc), std::move(t_children)) {
                assert(this->children.size() == 2);
            }
