    ...
    namespace dispatch {
       ...
       */
            ...
            struct Build_Function_Caller_Helper {
                Build_Function_Caller_Helper(std::vector<Const_Proxy_Function> t_funcs,
                ...
                Ret operator()(P &&... param) {
                    if (m_conversions) {
                        ...
                        return Function_Caller_Ret<Ret,
                            std::is_arithmetic<Ret>::value && !std::is_same<Ret, bool>::value>::call(m_funcs, {
                ...
                static auto box(
                    Q &&q) -> typename std::enable_if<
                    std::is_reference<P>::value && !std::is_same<chaiscript::Boxed_Value, typename std::remove_const<
                        typename std::remove_reference<P>::type>::type>::value, Boxed_Value>::type {
            ...
            std::function<Ret (Params...)> build_function_caller_helper(
                Ret(Params...), const std::vector<Const_Proxy_Function> & funcs,
...
*/
                ...
                return std::function < Ret(Params...) > (Build_Function_Caller_Helper<Ret, Params...>(
                           funcs, t_conversions ? t_conversions->get() : nullptr));
            }
        }
    }
}
