  ...
  /// \sa \ref adding_functions
    ...
    Proxy_Function fun(const T &t) {
        ...
        return Proxy_Function(
            chaiscript::make_shared<dispatch::Proxy_Function_Base, dispatch::Proxy_Function_Callable_Impl<Signature,
                T> >(t));
    }
    ...
    Proxy_Function fun(Ret (*func)(Param...)) {
        ...
        return Proxy_Function(
            chaiscript::make_shared<dispatch::Proxy_Function_Base, dispatch::Proxy_Function_Callable_Impl<Ret (Param...)
                , decltype(fun_call)> >(fun_call));
    }
    ...
    Proxy_Function fun(Ret (Class::*t_func)(Param...) const) {
        ...
        return Proxy_Function(
            chaiscript::make_shared<dispatch::Proxy_Function_Base, dispatch::Proxy_Function_Callable_Impl<Ret
                (const Class &, Param...), decltype(call)> >(call));
    }
    ...
    Proxy_Function fun(Ret (Class::*t_func)(Param...)) {
        ...
        return Proxy_Function(
            chaiscript::make_shared<dispatch::Proxy_Function_Base, dispatch::Proxy_Function_Callable_Impl<Ret
                (Class &, Param...), decltype(call)> >(call));
    }

    template<typename T, typename Class
        /*, typename = typename std::enable_if<std::is_member_object_pointer<T>::value>::type*/>
