...
namespace chaiscript {
    namespace detail {
        template<typename T>
        struct Bare_Type {
            typedef typename std::remove_cv<typename std::remove_pointer<typename std::remove_reference<
    ...
    class Type_Info {
    public:
        constexpr Type_Info(const bool t_is_const, const bool t_is_reference, const bool t_is_pointer,
        ...
        struct Get_Type_Info {
            static constexpr Type_Info get() {
                return Type_Info(
                    ...
                    && !std::is_same<typename std::remove_const<typename std::remove_reference<T>::type>::type,
                        bool>::value,
                    &typeid(T),
        ...
        struct Get_Type_Info<std::shared_ptr<T> > {
            ...
            static constexpr Type_Info get() {
                return Type_Info(std::is_const<T>::value, std::is_reference<T>::value, std::is_pointer<T>::value,
                                 std::is_void<T>::value,
                                 std::is_arithmetic<T>::value && !std::is_same<typename std::remove_const<typename
                                     std::remove_reference<T>::type>::type, bool>::value,
