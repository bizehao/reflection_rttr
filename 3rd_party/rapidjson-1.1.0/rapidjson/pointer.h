...
enum PointerParseErrorCode {
    ...
    //!< A character must percent encoded in URI
                                                 //!< fragment
};
...
public:
    ...
    */
    struct Token {
        const Ch *name;
        //!< Name of the token. It has null character at the end but it can contain
                         //!< null character.
    ...
    */
    ...
    /*!
       ...
       document root.
        \param unresolvedTokenIndex If the pointer cannot resolve a token in the pointer, this
       parameter can obtain the index of unresolved token.
...
private:
    ...
    */
    ...
    //!< The current allocator. It is either user-supplied or equal to
                              //!< ownAllocator_.
