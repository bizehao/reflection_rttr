...
The names has to a string literal (i.e. const char*) and provided via the function: @ref rttr::parameter_names ()
"parameter_names ()".
Place the call in the `()` operator of the returned @ref rttr::registration::bind "bind" object.
\remark
It is not possible to provide just one name, when you use this function, you have to provide names for **all**
arguments.
